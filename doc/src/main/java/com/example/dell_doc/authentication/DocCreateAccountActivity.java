...
public class DocCreateAccountActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_doc_create_account);
    ...
    public void cancel_clicked(View view) {
        Intent intent = new Intent(DocCreateAccountActivity.this, DocLoginActivity.class);
    ...
    private void register_user(String new_email, String new_pass) {
        ...
        dialog = new ProgressDialog(DocCreateAccountActivity.this, R.style.AppCompatAlertDialogStyle);
        ...
        mAuth.createUserWithEmailAndPassword(new_email, new_pass).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                ...
                if (task.isSuccessful()) {
                    //if successful
                    dialog.dismiss();
                    Toast.makeText(DocCreateAccountActivity.this, "User Registered Successfully", Toast.LENGTH_SHORT).show();

                    Intent intent = new Intent(DocCreateAccountActivity.this, DocNewProfileActivity.class);
                    intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                    startActivity(intent);
                    finish();
                } else {
                    ...
                    if (task.getException() instanceof FirebaseAuthUserCollisionException) {
                        dialog.dismiss();
                        Toast.makeText(DocCreateAccountActivity.this, "Email Already Registered", Toast.LENGTH_SHORT).show();
                    } else {
                        dialog.dismiss();
                        Toast.makeText(DocCreateAccountActivity.this, Objects.requireNonNull(task.getException()).getMessage(), Toast.LENGTH_SHORT).show();
                    }
                }
