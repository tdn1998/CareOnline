...
public class DocLoginActivity extends AppCompatActivity {
    ...
    public void create_account_clicked(View view) {
        Intent intent = new Intent(this, DocCreateAccountActivity.class);
        intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
        startActivity(intent);
        finish();
    }
    ...
    public void login_clicked(View View) {
        ...
        dialog = new ProgressDialog(DocLoginActivity.this, R.style.AppCompatAlertDialogStyle);
        ...
        mAuth.signInWithEmailAndPassword(email, pass).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                ...
                if (task.isSuccessful()) {
                    ...
                    dialog.dismiss();
                    Toast.makeText(DocLoginActivity.this, Objects.requireNonNull(task.getException()).getMessage(), Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
