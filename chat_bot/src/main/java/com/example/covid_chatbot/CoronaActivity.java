...
public class CoronaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnSend.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (checkInternetConnection() && !inputMessage.getText().toString().matches("")) {
                    sendMessage();
                } else if (inputMessage.getText().toString().matches("")) {
                    Toast.makeText(mContext, "Enter Query", Toast.LENGTH_SHORT).show();
                }
            }
        });
    ...
    private void recordMessage() {
        if (!listening) {
            ...
            listening = true;
            Toast.makeText(CoronaActivity.this, "Listening....Click to Stop", Toast.LENGTH_LONG).show();

        } else {
            try {
                microphoneHelper.closeInputStream();
                listening = false;
                Toast.makeText(CoronaActivity.this, "Stopped Listening....Click to Start", Toast.LENGTH_LONG).show();
            } catch (Exception e) {
                e.printStackTrace();
            }
    ...
    private void showError(final Exception e) {
        runOnUiThread(new Runnable() {
            @Override
            public void run() {
                Toast.makeText(CoronaActivity.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                e.printStackTrace();
            }
        });
    }
